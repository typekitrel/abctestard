...
# https://github.com/coder-alpha/DumbTools-for-Plex
# https://forums.plex.tv/discussion/194503
import urllib2

# Anmeldung erforderlich - s.CheckAuth / z.Z. ab abgeschaltet
...
class DumbPrefs:
	clients = ['Plex for iOS', 'Plex Media Player', 'Plex Home Theater',
			   'OpenPHT', 'Plex for Roku', 'Plex Web']
